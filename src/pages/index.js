...
const IndexPage = () => (
  <div>
    ...
    <p>
      ...
      Fire up the terminal (on Linux systems Crl+Alt+t or on Windows open the <a target="_blank" href="https://git-scm.com/download/win">Git-bash</a> ) and navigate to your desired directory and type the following command. Replace the link with the clone URL of your repository and hit Enter.
    ...
    <h3>Step 7</h3>
    <p>
      Now, open your web browser and go to the <a target="_blank" href="https://github.com/rishabh-bansal/GitStart"> original repository on GitHub</a>. If your changes has been pushed to your forked copy, You'll be able to see an option saying "New Pull Request" in the original repository.
      Click on the option, one next page choose the master branch of the main repo against your created-branch name ( choose your branch name we created and not master). Then click on create pull request. Once you fill in the commit message and comment click on submit pull request. <br/>
